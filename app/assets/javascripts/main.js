...
CurLux.events.push(CurLux.slider.init);
// end slitslider module


// search bar module
CurLux.searchButton = function() {
    var h = '295px';
...
CurLux.events.push(CurLux.searchButton);
// end search bar module


// pie chart module
CurLux.pieChart = function(obj){
    var time = 1500;
...
CurLux.events.push(CurLux.pieChart);
// end pie chart module

// slider control module
CurLux.sliderControl = function(){
...
CurLux.events.push(CurLux.sliderControl);
// end slider control module


// accordion icons module
CurLux.accordionIcon = function(){
    var
...
CurLux.events.push(CurLux.accordionIcon);
// end accordion icons module


// scroll effects module
CurLux.scrollController = function() {
    var
    ...
    if ($parallax.length > 0) {
        var testMobile = CurLux.isMobile.any();
        if (testMobile === null) {
...
CurLux.events.push(CurLux.scrollController);
// end scroll effects module


// isotope module
CurLux.isotope = function(){
  var
    $container = $('#isotope'),
    $filter = $('#filters'),
    instance = null,
...
CurLux.events.push(CurLux.isotope);
// end isotope module


// google maps module
CurLux.gmaps = function(){
    var
        $elem = $('#map-canvas'),
        options = window.mapOptions || {},
        apiLoad = function() {
            $.getScript('https://maps.googleapis.com/maps/api/js?v=3.exp&callback=CurLux.gmaps')
...
CurLux.events.push(CurLux.gmaps);
// end google maps module



// Ajax portfolio module
CurLux.portfolio = function(){
    var
...
CurLux.events.push(CurLux.portfolio);
// end Ajax portfolio module



// Contacts form module
CurLux.contactForm = function(){
    var
        $form = $('#contactForm'),
...
CurLux.events.push(CurLux.contactForm);
